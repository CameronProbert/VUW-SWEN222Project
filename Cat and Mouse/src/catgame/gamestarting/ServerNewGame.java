...
/**
 * A server New Game sets up the server for a new game, 
 * it holds the Master objects and accepts connections from the clients
 * It differs slightly to the server old game in the way the handler is set up 
 * and the way the files are loaded 
 * 
 * @author Francine
 *
 */
...
public class ServerNewGame extends StartServer {
	...
	/**
	 * gives the masters their uids, generated by the network handler
	 */
