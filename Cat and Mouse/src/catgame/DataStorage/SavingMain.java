...
public class SavingMain {
	...
	public static void main(String[] args) throws FileNotFoundException,
		...
		boardCell[0][0] =new BoardCell(new Position(0, 1), new Rock(24), null);
		boardCell[0][0] = new BoardCell(new Position(1, 0), new Tree(25), null);
		boardCell[0][0] =  new BoardCell(new Position(1, 1), new Tree(26), null);
